...
function Events() {
    ...
    const eventsData = [
        ...
        },
        {
            ...
            date: '2024-12-03',
            description: 'Exciting events hosted by NYU Tandon School of Engineering.',
            image: 'https://via.placeholder.com/300x200',
    ...
    return (
        ...
        <div style={{paddingTop: "130px", textAlign:"center"}}></div>
            <LocalizationProvider dateAdapter={AdapterDayjs}>
                <Box sx={{ p: 4 }}>
                    {/* 页面标题 */}
                    <Typography class = 'Silkscreen' style={{fontSize:"210%", textTransform: 'uppercase', textAlign: "center",}}>
                        NYU Tandon CSSA Events
                    </Typography>
                            ...
                            filteredEvents.map((event) => (
                                <Grid item xs={12} key={event.id}>
                                    <Card
                                        sx={{
                                            display: 'flex',
                                            flexDirection: { xs: 'column', md: 'row' }, // 小屏上下堆叠，大屏左右排列
                                        }}
                                    >
                                        {/* 左侧活动信息 */}
