        ...
        <ThemeProvider theme={theme}>
            <Box
                ...
                <ul>
                    ...
                    <li>
                        <Typography gutterBottom>
                        到达海关大厅，排队准备入境。排队过程中提前把护照、I-20等文件拿出来
                        </Typography>
                    </li>
                    <li>
                        <Typography gutterBottom>
                        在入境闸口处接受海关人员询问，检查必要文件
                        </Typography>
                    </li>
                    <li>
                        <Typography gutterBottom>
                ...
                <Typography gutterBottom>
                    <ol>
                        <li>过关时不要打电话，不要拍照。</li>
                        <li>入关的类型分两种，一种是美国公民或者永久居民的（US Citizens and Permanent Residents）,第二个是给非美国居民的（Non Residents/Foreign Nationals）如果非美国绿卡或者公民入关，排在非美国居民的窗口。</li>
                        <li>机场有小推车可以使用，需支付硬币。</li>
                    </ol>
                </Typography>
