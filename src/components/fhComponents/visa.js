        ...
        <ThemeProvider theme={theme}>
            ...
            >
                ...
                <Box component="ul" sx={{ listStyle: 'none', padding: 0, mb: 4, ...lightPurpleBackground }}>
                    ...
                    <li>
                        <Typography variant="h6" gutterBottom sx={{ lineHeight: 4, mb: 1, fontWeight: 'bold', fontSize: { xs: '1rem', md: '1.5rem' } }}>
                            2. 接受录取并保存录取通知书
                        </Typography>
                        <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', my: 5, flexDirection: { xs: 'column', md: 'row' } }}>
                            <Box
                                component="img"
                                src={NYUStartImage}
                                alt="NYU start page"
                                sx={{ width: { xs: '100%', md: '50%' }, height: 'auto', mr: { xs: 0, md: 3 }, mb: { xs: 3, md: 0 } }}
                            />
                            <OfferSteps />
                        </Box>
                    </li>
